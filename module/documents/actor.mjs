...
export class LHTrpgActor extends Actor {
     ...
     */
    prepareDerivedData() {
        const jobStats = CONFIG.LHTRPG.Jobs;        
        const raceStats = CONFIG.LHTRPG.Races;          
        ...
        if (actorData.type === 'character') {
            ...
            if (raceStats.hasOwnProperty(race)) {
            ...
            if (jobStats.hasOwnProperty(job)) {                
